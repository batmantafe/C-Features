...
public class KeepWithinScreen : MonoBehaviour
{
    ...
    Vector3 CheckBounds() // Uses the Current Position and Renderer's Bounds to check whether the 'sprite' has hit the sides of the screen. It then adjusts the position to stay within the screen.
    {
